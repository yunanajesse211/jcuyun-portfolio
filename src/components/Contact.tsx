...
import { Mail, Github, Phone, MapPin, Send, Loader2, Facebook, MessageCircle } from "lucide-react";
          ...
          <div className="order-2 md:order-1">
            <div className="bg-black/30 border border-datamind-primary/30 rounded-lg p-6 md:p-8 backdrop-blur-sm h-full">
              ...
              <div className="mt-8 flex gap-4">
                ...
                <a href="https://www.facebook.com/godsgift.jesse.jcguy/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-datamind-primary/20 flex items-center justify-center hover:bg-datamind-primary/40 transition-colors group">
                  <Facebook className="h-4 w-4 md:h-5 md:w-5 text-datamind-primary group-hover:scale-110 transition-transform" />
                </a>
                <a href="https://wa.me/2347034693441" target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-datamind-primary/20 flex items-center justify-center hover:bg-datamind-primary/40 transition-colors group">
                  <MessageCircle className="h-4 w-4 md:h-5 md:w-5 text-datamind-primary group-hover:scale-110 transition-transform" />
                </a>
              </div>
            </div>
          </div>
